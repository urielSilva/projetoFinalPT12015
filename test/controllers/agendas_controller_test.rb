...
class AgendasControllerTest < ActionController::TestCase
  ...
  test "should create agenda" do
    assert_difference('Agenda.count') do
      post :create, agenda: { agenda_date: @agenda.agenda_date, agenda_description: @agenda.agenda_description, agenda_name: @agenda.agenda_name }
    end
  ...
  test "should update agenda" do
    patch :update, id: @agenda, agenda: { agenda_date: @agenda.agenda_date, agenda_description: @agenda.agenda_description, agenda_name: @agenda.agenda_name }
    assert_redirected_to agenda_path(assigns(:agenda))
  end
